...
const levels = [
    ...
    { id: 10, mainWord: 'SPRING', wordsToFind: ['spring', 'rings', 'spin', 'pig'] },
    { id: 11, mainWord: 'GOLDEN', wordsToFind: ['golden', 'longed', 'gone', 'dog'] },
    ...
    { id: 27, mainWord: 'KITCHEN', wordsToFind: ['kitchen', 'thicken', 'nick', 'hit', 'ten'] },
    ...
    { id: 35, mainWord: 'PERFECT', wordsToFind: ['perfect', 'creep', 'tree', 'pet', 'cry'] },
    ...
    { id: 58, mainWord: 'TROPICAL', wordsToFind: ['tropical', 'capital', 'trap', 'car', 'tap', 'top'] },
    ...
    { id: 63, mainWord: 'CHRISTMAS', wordsToFind: ['christmas', 'charism', 'char', 'car', 'ham', 'sit', 'mix'] },
    ...
    { id: 86, mainWord: 'INSTRUMENT', wordsToFind: ['instrument', 'minster', 'term', 'tin', 'sit', 'sun', 'run', 'net'] },
    ...
    { id: 96, mainWord: 'GENERATION', wordsToFind: ['generation', 'negation', 'rage', 'age', 'ten', 'tan', 'got', 'ton'] },
    { id: 97, mainWord: 'LABORATORY', wordsToFind: ['laboratory', 'boat', 'bat', 'lab', 'rat', 'toy', 'boy', 'rot'] },
    { id: 98, mainWord: 'CALCULATOR', wordsToFind: ['calculator', 'cool', 'car', 'cut', 'too', 'lot', 'cot', 'art'] },
