...
const levels = [
    ...
    { id: 13, mainWord: 'HUNTER', wordsToFind: ['hunter', 'rent', 'hunt', 'hut'] },
    ...
    { id: 22, mainWord: 'CAPITAL', wordsToFind: ['capital', 'pit', 'tail', 'cap', 'tap'] },
    ...
    { id: 40, mainWord: 'ELEPHANT', wordsToFind: ['elephant', 'heal', 'plant', 'late', 'pen', 'hat'] },
    { id: 41, mainWord: 'COMPUTER', wordsToFind: ['computer', 'compute', 'court', 'cut', 'put', 'rot'] },
